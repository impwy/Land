...
<%@ include file="../include/header.jsp"%>
	...
	<form id="form1">
        ...
        <input type="hidden" id="amount" name="ticket_amount"  value="${map.ticket_amount }" />
       	...
       	<table>
       	<tr>
       	<th><label for="name">이름</label><td><input type="text" id="name"  value="${member.member_name }" />
       	</tr>
       	<tr>
        <th><label for="email">이메일</label><td><input type="text" id="email" name="ticket_email" readonly value="${member.member_email }" />
        </tr>
        <tr>
        <th><label for="phone">연락처 </label><td><input type="text" id="phone" name="ticket_phone" readonly value="${member.member_phone }" />
        </tr>
        <tr>
        <th><label for="date">방문날짜 </label><td><input type="text" id="date" name="ticket_date" readonly value="${map.ticket_date }" />
        </tr>
        </table>
       	</div>
       	<hr>
        ...
        <div class="ticket-amount">${map.baby_amount} 장</div>
       	...
       	<hr>
       	<div>결제 금액 &nbsp;&nbsp;<input type="number" id="sum" name="ticket_sum" value="${map.ticket_sum }" readonly/></div>
