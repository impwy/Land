...
<body class="basketlist">
	...
	<table>
		...
		<tr>
			<td><input type="button" id="payCart" onclick="payCart()"
				value="결제하기" /> <input type="hidden" name="hiddenbtn"
				id="hiddenbtn" value="cartpage" /> <input type="button" id="home"
                            ...
                            if ($("input[name=chk]:checkbox:checked").length == 0) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                    	...
                                    	/* window.open('goodsPayment','','height=500' + popupHeight  + ', width=700' + popupWidth  + ', left='+ popupX + ', top='+ popupY); */
