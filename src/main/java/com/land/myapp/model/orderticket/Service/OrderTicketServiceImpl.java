...
public class OrderTicketServiceImpl implements OrderTicketService{
	...
	//TICKET_NUM 생성
	private void makeNum(OrderTicketDTO vo) {
	...
	//티켓정보 등록
	@Override
	public void insertOrderTicket(OrderTicketDTO vo) {
		makeNum(vo);
	...
	//티켓 조회
	public List<OrderTicketDTO> getOrderTicketList(String member_id, int start, int end) {
