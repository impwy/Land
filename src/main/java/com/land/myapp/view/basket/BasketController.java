...
public class BasketController {
	...
	public String insertBasket(BasketDTO vo) {
	...
	public String deletebasket(BasketDTO vo) {
	...
	public String listbasket(Model model, BasketDTO vo, HttpSession session, GoodsDTO gvo) {
	...
	public String getSelectOne(BasketDTO vo, Model model) {
		// 정수 변수 "goods_num" 및 "모델" 개체 "model"의 두 매개 변수를 사용
		BasketDTO basketvo = basketservice.getSelectOne(vo);
	...
	//굿즈  페이지 이동
			...
			public String orderGoods(GoodsPaymentDTO vo, HttpSession session, GoodsDTO gvo, String basket) {
			...
			public String paymentGoods(GoodsPaymentDTO vo) {
				return "/payment/goodsPayment";
			}
