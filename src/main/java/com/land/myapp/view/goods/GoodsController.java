...
import com.land.myapp.model.goods.Service.GoodsService;
...
public class GoodsController {
	...
	public String goodsViewList(@RequestParam(defaultValue = "1") int curPage, GoodsDTO vo, Model model) {
		int count = goodsService.getCountGoods(vo);
		Pager pager = new Pager(count,curPage);
		int start = pager.getPageBegin();
		int end = pager.getPageEnd();
		
		List<GoodsDTO> list = goodsService.getGoodsList(start, end, vo);
	...
	//굿즈 삭제 
		...
		GoodsDTO result = goodsService.getGoodsInfo(goods_num);
...
//		}
		...
		public String updateGoods(GoodsDTO vo) {
	...
	public String insertGoods(GoodsDTO vo) {
	...
	public String adminView(GoodsDTO vo) {
		...
		public String goodsAdminViewList(@RequestParam(defaultValue = "1") int curPage, GoodsDTO vo, Model model) {
			int count = goodsService.getCountGoods(vo);
			Pager pager = new Pager(count,curPage);
			int start = pager.getPageBegin();
			int end = pager.getPageEnd();
		...
		public String getGoodsInfo(GoodsDTO vo, int goods_num, Model model) {
